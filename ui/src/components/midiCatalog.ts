...
export const MAPPABLE_TARGETS: MappableTarget[] = [
  ...
  { id: 'gateEnabledRight', name: 'Gate R Power', group: 'Noise Gate', kind: 'toggle' },
  { id: 'gateLinked', name: 'Gate Link', group: 'Noise Gate', kind: 'toggle' },
  {
    id: 'gateThresholdRight',
    name: 'Gate R Threshold',
    group: 'Noise Gate',
    kind: 'continuous',
  },
